package com.devqt.fity.days_b.mat_b_t;
...
public class ChtBThirdMat extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1vv8ntfFIpGz479-SG9VvkZKlRFeUiEFCeo4doYv0GwA/pubhtml?gid=1201254613&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ChtBThirdMat.this);
