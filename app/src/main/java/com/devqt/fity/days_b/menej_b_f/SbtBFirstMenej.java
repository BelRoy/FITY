package com.devqt.fity.days_b.menej_b_f;
...
public class SbtBFirstMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/17nL-WSLFbCAfcbjqoQ1EmYP9Z7zGqdg5GLhMPkyW9QE/pubhtml?gid=1072860710&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtBFirstMenej.this);
