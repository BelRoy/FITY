package com.devqt.fity.days_b.menej_b_fo;
...
public class SbtBFourthMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/17QhBF_rDg9h1rtnHZH66JikvPWGXAKK5MfcP0N6qv88/pubhtml?gid=1857405625&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtBFourthMenej.this);
