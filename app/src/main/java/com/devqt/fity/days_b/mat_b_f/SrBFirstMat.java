...
public class SrBFirstMat extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1JtyZd-NZr4p15x3gMnHP-fWeud4Ana4QN1BWVHkYyj0/pubhtml?gid=2025918385&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
   ...
   protected void onCreate(Bundle savedInstanceState){
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SrBFirstMat.this);
