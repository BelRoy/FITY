...
public class ChtBSecondMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1-byCZAWGoTBQrWQ2stXF1ICF6zzzRhNuoCd2UIpt3M8/pubhtml?gid=705318776&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ChtBSecondMenej.this);
