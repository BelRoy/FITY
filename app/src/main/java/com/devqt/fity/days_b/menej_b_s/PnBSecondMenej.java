...
public class PnBSecondMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1sjhBaBd8E2bpzHRyw_cyBbu09VODRuG7vbpeoojibQw/pubhtml?gid=571095086&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PnBSecondMenej.this);
