...
public class PtBFourthMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1azANage3x-gTLNNdGBo_ZkWe8tO9UFgkiGEloPnOpoA/pubhtml?gid=608068535&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PtBFourthMenej.this);
