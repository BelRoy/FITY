package com.devqt.fity.days_b.menej_b_s;
...
public class SbtBSecondMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1gy5tpRU82fxW70cFc3OAVWLyDIWA4c5Wev9Mma3gmuA/pubhtml?gid=1094404876&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtBSecondMenej.this);
