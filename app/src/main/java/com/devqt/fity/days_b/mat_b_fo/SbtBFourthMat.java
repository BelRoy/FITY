package com.devqt.fity.days_b.mat_b_fo;
...
public class SbtBFourthMat extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1iKiNfegWitIwXRbUbenzJCrkVQf02P1ZbthCTRSReEM/pubhtml?gid=1274363999&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtBFourthMat.this);
