...
public class PnBThirdMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1xmydx3BNHf-LsQzF34bKvVs-bgeyKbbnhppneIs7pNA/pubhtml?gid=815963834&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PnBThirdMenej.this);
