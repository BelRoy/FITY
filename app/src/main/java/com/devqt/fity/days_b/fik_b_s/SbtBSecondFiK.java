package com.devqt.fity.days_b.fik_b_s;
...
public class SbtBSecondFiK extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1BkLwJgiNMA1775avtLg7xYb_STtcXpdbMMN1xn9OiIY/pubhtml?gid=1191610270&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtBSecondFiK.this);
