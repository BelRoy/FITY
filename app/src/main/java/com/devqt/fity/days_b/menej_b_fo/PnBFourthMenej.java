...
public class PnBFourthMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1nFAAXddcXaxfVufdcVjO34GPNKvOnnnVOCFhO_cr8k4/pubhtml?widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PnBFourthMenej.this);
