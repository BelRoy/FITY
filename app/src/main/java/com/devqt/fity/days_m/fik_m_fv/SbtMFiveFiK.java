package com.devqt.fity.days_m.fik_m_fv;
...
public class SbtMFiveFiK extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1RZOay8Kn6K5l7yhrAB6Tshy989xVNRnmlrxfkgXuJ9c/pubhtml?gid=1245097950&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtMFiveFiK.this);
