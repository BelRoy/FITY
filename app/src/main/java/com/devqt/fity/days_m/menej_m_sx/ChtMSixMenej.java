package com.devqt.fity.days_m.menej_m_sx;
...
public class ChtMSixMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1mk9CRX9mrg4xBHaJZ_9qteQJsKZ_CrzCQ6RVWbFhO-g/pubhtml?gid=1005296014&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ChtMSixMenej.this);
