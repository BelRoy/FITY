...
public class VtMSixMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1-pwe42wjDPMLPe3HbopALsM_aRdOgClR7FIOdtMYfbo/pubhtml?gid=2001974170&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(VtMSixMenej.this);
