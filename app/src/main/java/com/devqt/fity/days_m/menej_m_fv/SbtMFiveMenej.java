package com.devqt.fity.days_m.menej_m_fv;
...
public class SbtMFiveMenej extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1rw6USiWjIRGfq_186xn_yLcIEGHFYYmNb5bH0McrQGA/pubhtml?gid=1079712800&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtMFiveMenej.this);
