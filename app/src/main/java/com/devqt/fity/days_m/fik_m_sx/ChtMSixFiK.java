package com.devqt.fity.days_m.fik_m_sx;
...
public class ChtMSixFiK extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1SVLCXrTdkDgTBaUlnIiFCmV4advccMGMPDtCK7cW5Yk/pubhtml?gid=1370986871&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(ChtMSixFiK.this);
