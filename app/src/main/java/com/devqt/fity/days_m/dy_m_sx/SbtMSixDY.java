package com.devqt.fity.days_m.dy_m_sx;
...
public class SbtMSixDY extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1p2_n0vyRSkbm1VwMRfGnJTxXFJJKv2d0yb269TicPRM/pubhtml?gid=1133723955&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtMSixDY.this);
