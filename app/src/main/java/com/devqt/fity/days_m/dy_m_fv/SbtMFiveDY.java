package com.devqt.fity.days_m.dy_m_fv;
...
public class SbtMFiveDY extends AppCompatActivity {

    String _URL = "https://docs.google.com/spreadsheets/d/1r2iOU-vBOoG5AObg8guV23PWeKsMRSQkBPnJDkHvwfk/pubhtml?gid=1342496429&amp;single=true&amp;widget=false&amp;headers=false&amp;chrome=false";
    ...
    public class _JSOUP extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(SbtMFiveDY.this);
